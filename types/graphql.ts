...
export type TripsQueryQuery = { __typename?: 'Query', trips: Array<{ __typename?: 'Trip', id: string, title: string, description?: string | null }> };
